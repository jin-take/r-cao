...
export default function ApprovalsPage() {
  ...
  const mppPending = pending.filter((item) => item.approvalType === "POLICY_EXCEPTION").length;
  ...
  return <section className="shell">
    ...
    {mppPending > 0 && <p className="notice">MPP Policy Exceptionが {mppPending} 件あります。支払scopeとWallet networkを確認してから <Link className="text-link" href="/payments">MPP Payment Approvalへ進む →</Link></p>}
